...
class CandidateControllerTest {
    ...
    @Test
    public void whenPostCandidateWithFileThenSameDataAndRedirectToErrorPage() {
    ...
    @Test
    public void whenRequestCandidateThenGetUpdatePage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    public void whenRequestUpdateCandidateThenUpdateAndRedirectToCandidatesPage() throws Exception {
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
        ...
        var model = new ConcurrentModel();
        var candidate = new Candidate(1, "test2", "desc2", now(), 1, 2);
    ...
    @Test
    public void whenRequestUpdateAbsentCandidateThenErrorPage() throws Exception {
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenRequestDeleteCandidateThenDeleteAndRedirectToCandidatesPage() {
